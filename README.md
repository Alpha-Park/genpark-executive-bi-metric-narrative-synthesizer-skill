# genpark-executive-bi-metric-narrative-synthesizer-skill
...
<p align="center">
  <b>Production-Grade Spreadsheet & Business Intelligence Agent Skill</b> • <b>100% Standard Library Python</b> • <b>Native Model Context Protocol (MCP)</b>
</p>
...
**genpark-executive-bi-metric-narrative-synthesizer-skill** is a deterministic, zero-dependency Python skill engineered for autonomous spreadsheet data sanitization, reverse CTE SQL synthesis, and executive BI analytics.

> **Executive Capability**: Executive BI KPI metric narrative brief synthesizer (Tableau Pulse)
...
```mermaid
graph LR
    User([🌐 BI Analyst / Data Agent]) -->|JSON-RPC Request| MCP[⚡ MCP Server / CLI]
...
result = client.synthesize_executive_brief()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-executive-bi-metric-narrative-synthesizer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-executive-bi-metric-narrative-synthesizer-skill/mcp_server.py"]
    }
  }
}
```
...
Explore the comprehensive directory of 1,200+ open-source, production-ready AI Agent skills at the [GenPark AI MCP Hub](https://genpark.ai/mcp) and learn more about data analytics and spreadsheet agents at [GenPark AI](https://genpark.ai).
